...
| 施工环境角色 | 独立 |
| 无人值守许可 | 允许 |
| 任务规格位置 | docs/tasks/specs/candidate-proof/task-spec-V1.md |
...
- [详细任务规格 V1](/Users/chris/.codex/worktrees/77ea/workflow-manager/docs/tasks/specs/candidate-proof/task-spec-V1.md) 是确认后实施事实源；[Definition Check](specs/candidate-proof/definition-check.md) 记录定义完成情况。
