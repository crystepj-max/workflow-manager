...
test('开发粘贴用 dynamic 闭包合计 ≤ 192KB（一次 cordis_define 载荷），host 自带头部常量与 Buffer 垫片', () => {
  ...
  // LOC-030 统一受阻生命周期（终止描述派生 + 宿主描述优先映射/恢复入口 + 看板受阻口径）
  // 并入后上调至 192KiB（人工裁决授权提预算：190KiB 余量 467B 低于 V1 忠实实现最小增量）。
