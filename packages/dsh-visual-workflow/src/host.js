  ...
  apply(ctx) {
    ...
    function hydrateLogicalRunFromDisk(data) {
      ...
      const rec = {
        ...
        evaluation_baseline: data.evaluation_baseline && typeof data.evaluation_baseline === 'object' ? data.evaluation_baseline : null,
        evaluation_baselines: Array.isArray(data.evaluation_baselines) ? data.evaluation_baselines.filter((r) => r && typeof r === 'object') : [],
        formal_records: data.formal_records && typeof data.formal_records === 'object' ? data.formal_records : null,
