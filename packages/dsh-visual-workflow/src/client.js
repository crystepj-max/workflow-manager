...
.vwf-msg-line.ok { color:var(--vwf-ok); }
.vwf-msg-line.bad { color:var(--vwf-err); }
.vwf-msg-line.warn { color:var(--vwf-warn); }
.vwf-msg-line.muted { color:var(--vwf-text-3); }
...
.vwf-canvas-wrap { position:relative; height:560px; overflow:auto; display:flex; border-top:1px solid var(--vwf-border); background:var(--vwf-canvas); overscroll-behavior:contain; }
...
.vwf-zoom button:hover { background:var(--vwf-accent-surface); }
...
.vwf-dialog-mask { position:fixed; inset:0; z-index:950; background:var(--vwf-mask); display:flex; align-items:center; justify-content:center; padding:var(--vwf-safe-gap); overflow:auto; }
.vwf-dialog { width:min(520px, 92vw); max-height:calc(100vh - 2 * var(--vwf-safe-gap)); display:flex; flex-direction:column; border:1px solid var(--vwf-border); border-radius:14px; background:var(--vwf-surface); color:var(--vwf-text); box-shadow:0 24px 64px rgba(0,0,0,.5); padding:16px; gap:10px; }
.vwf-confirm-mask { position:fixed; inset:0; z-index:960; background:var(--vwf-mask); display:flex; align-items:center; justify-content:center; padding:var(--vwf-safe-gap); overflow:auto; }
...
.vwf-confirm-actions { display:flex; justify-content:flex-end; gap:8px; flex-wrap:wrap; }
...
.vwf-handle-src:hover { fill:var(--vwf-accent); }
.vwf-entry-badge { fill:var(--vwf-surface); stroke:var(--vwf-border-strong); }
.vwf-entry-badge-text { fill:var(--vwf-text-2); font-size:10px; }
`)
      ...
      Object.keys(pos).forEach((id) => {
        ...
        if (isTerm) {
          nodeEls.push(h('g', {
            ...
            h('rect', { width: p.w, height: p.h, rx: p.h / 2, fill: 'var(--vwf-surface)', stroke: isConnectTarget ? ACCENT : 'var(--vwf-border-strong)', strokeWidth: isConnectTarget ? 3 : 1, strokeDasharray: '5 4', opacity: 0.9, ...(isConnectTarget ? { 'data-vwf-connect-target': 'true' } : {}) }),
            h('text', { x: p.w / 2, y: p.h / 2 + 4, textAnchor: 'middle', fontSize: 12, fill: 'var(--vwf-text-2)' }, t('endNode')),
