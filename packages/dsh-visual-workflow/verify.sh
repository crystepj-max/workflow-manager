...
echo '—— Gate4 包测试 ——'
node --test tests/host.test.mjs tests/runs-persistence.test.mjs tests/client.smoke.mjs tests/static-bundle.test.mjs tests/dist-fresh.test.mjs tests/schema-template.test.mjs
