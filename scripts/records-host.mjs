...
const COMMANDS = { commit: recordsCommit, list: recordsList, get: recordsGet, attempt: recordsAttempt, assertIntegration: recordsAssertIntegration, assertCandidates: recordsAssertCandidates }
