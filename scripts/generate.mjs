...
export function compileBlueprint(bp, opts = {}) {
  ...
  lines.push(
    ...
    '  if (A.workspace_capability) s += \'\\n- workspace 能力令牌（仅限本 Run 使用，禁止用于其他 Run 的 taskId）：\' + A.workspace_capability + \'——业务文件读写必须经工具 vwf_workspace_write / vwf_workspace_read（参数 taskId=任务标识、capability=本令牌），不得直接改主仓库或共享 cwd\'',
